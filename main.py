...
def generate_qrcode():
    ...
    qr_image_tk = ImageTk.PhotoImage(Image.open(".venv/qrcode.png"))
...
# Generate button
button_generate = tk.Button(root, text="Generate QR Code", command=generate_qrcode,
    font=("Helvetica", 12), bg="#007bff", fg="white", activebackground="#0056b3", activeforeground="white", padx=10, pady=5)
